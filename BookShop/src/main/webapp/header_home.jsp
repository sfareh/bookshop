...
<!-- Start Slider area -->
<div
	class=" slider-area brown__nav slider--15 slide__activation slide__arrow01 owl-carousel owl-theme m-5">
	<!-- Start Single Slide -->
	<div
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="slider__content">
						<div class="contentbox text-right">
							<h2 class="text-white text-right small">Buy your</h2>
							<h2 class="text-white text-right small">favourite Book</h2>
							<h2 class="text-white text-right small">from here</h2>
							<a class="shopbtn text-white " href="ShopGrid">shop now</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-12 col-sm-6">
					<div class="slider__content">
						<div class="contentbox">
							<!--  
		            				<h2 class="text-white">Buy <span>your </span></h2>
		            				<h2 class="text-white">favourite <span>Book </span></h2>
		            				<h2 class="text-white">from <span>Here </span></h2>
		            				<a class="shopbtn text-white mt-5" href="#">shop now</a>
		            				-->
