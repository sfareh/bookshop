							...
							<div class="col-lg-12">
								<div
									...
									<div class="orderby__wrapper">
										<span style="color: #e59285; font-size: 18px">${ cartegoryName }</span>
						...
						<div class="tab__container">
							<div class="shop-grid tab-pane fade show active" id="nav-grid"
								...
								<div class="row">
									...
									for (int i = 0; i < bookByCat.size(); i++) {
									%>
									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="product">
											<div class="product__thumb">
												<a class="first__img"
													href="SingleProduct?id=<%=bookByCat.get(i).getId()%>">
													<img class="gridForm"
													src="<%=bookByCat.get(i).getImage()%>" alt="product image">
												</a>
											...
											<div class="product__content">
												<h4>
													<a href="SingleProduct?id=<%=bookByCat.get(i).getId()%>"><%=bookByCat.get(i).getTitle()%></a>
												</h4>
												<h4>
													<a href="SingleProduct?id=<%=bookByCat.get(i).getId()%>"><%=bookByCat.get(i).getName()%></a>
												</h4>
											</div>
										</div>
									</div>
								...
								<nav aria-label="Page navigation example">
									<ul class="pagination">
										...
										<li class="page-item"><a class="page-link"
											href="CategoryS?pagination=<%=i%>&catId=<%=bookByCat.get(0).getCategory_id()%>"><%=i%></a></li>
										<%
										}
										%>
									</ul>
